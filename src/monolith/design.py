...
def TAIL(x0: float, y0: float, x1: float, y1: float, t: float) -> Poly:  # thick diagonal stroke
    ...
    return Poly(((x0 - nx, y0 - ny), (x1 - nx, y1 - ny),
                 (x1 + nx, y1 + ny), (x0 + nx, y0 + ny)), hole=False)
...
DES: dict[str, Glyph] = {
    ...
    "Q": Glyph(620, (Q((0, 0), (340, 0), (620, 280), (620, 700), (0, 700)),
                     Q((414, 0), (620, 0), (620, 206)),
                     Cc(230, 300, 390, 480))),
    "R": Glyph(620, (R(0, 0, 260, 700), R(260, 300, 620, 700), Cc(360, 420, 500, 580),
    ...
    "V": Glyph(620, (Q((0, 700), (240, 700), (430, 0), (190, 0)),
                     Q((380, 700), (620, 700), (430, 0), (190, 0)))),
    "W": Glyph(620, (Q((0, 700), (190, 700), (250, 0), (60, 0)),
                     Q((230, 700), (390, 700), (230, 0), (70, 0)),
                     Q((230, 700), (390, 700), (550, 0), (390, 0)),
                     Q((430, 700), (620, 700), (560, 0), (370, 0)))),
    "X": Glyph(620, (Q((0, 0), (620, 440), (620, 700), (0, 260)),
                     Q((0, 440), (620, 0), (620, 260), (0, 700)))),
    "Y": Glyph(620, (Q((0, 700), (240, 700), (400, 290), (160, 290)),
                     Q((380, 700), (620, 700), (460, 290), (220, 290)),
                     R(180, 0, 440, 460))),
    "Z": Glyph(620, (R(0, 480, 620, 700), R(0, 0, 620, 220),
                     Q((250, 220), (420, 220), (590, 480), (420, 480)))),
    # --- figures ---
    "zero": Glyph(620, (R(0, 0, 620, 700),
                        Cc(215, 180, 405, 520),
    ...
    "five": Glyph(620, (R(0, 480, 420, 700), R(0, 140, 260, 480),
                        R(0, 140, 620, 300), R(260, 0, 620, 140))),
    ...
    "semicolon": Glyph(240, (R(0, 0, 200, 160), R(0, 420, 200, 580),
                             TAIL(160, 80, 40, -160, 160))),
    "exclam": Glyph(200, (R(0, 220, 200, 700), R(0, 0, 200, 160))),
    "question": Glyph(460, (R(0, 500, 460, 700), R(260, 340, 460, 500),
                            R(160, 160, 360, 340), R(160, 0, 360, 120))),
    ...
    "parenleft": Glyph(460, (Q((300, 700), (460, 700), (340, 350), (180, 350)),
                             Q((180, 350), (340, 350), (460, 0), (300, 0)))),
    "parenright": Glyph(460, (Q((160, 700), (0, 700), (120, 350), (280, 350)),
    ...
    "braceleft": Glyph(460, (R(340, 0, 460, 700), R(180, 560, 460, 700),
                             R(180, 0, 460, 140), R(0, 300, 360, 400))),
    "braceright": Glyph(460, (R(0, 0, 120, 700), R(0, 560, 280, 700),
                              R(0, 0, 280, 140), R(100, 300, 460, 400))),
    "slash": Glyph(620, (Q((0, 0), (160, 0), (620, 700), (460, 700)),)),
    "backslash": Glyph(620, (Q((460, 0), (620, 0), (160, 700), (0, 700)),)),
    "bar": Glyph(160, (R(0, -60, 160, 760),)),
    "asterisk": Glyph(530, (R(230, 430, 390, 700), R(90, 505, 530, 625),
    ...
    "less": Glyph(500, (Q((140, 350), (480, 610), (480, 700), (140, 510)),
                        Q((140, 190), (480, 0), (480, 90), (140, 350)))),
    "greater": Glyph(500, (Q((480, 350), (140, 610), (140, 700), (480, 510)),
                           Q((480, 190), (140, 0), (140, 90), (480, 350)))),
    "numbersign": Glyph(620, (R(100, 0, 260, 700), R(420, 0, 580, 700),
                              R(0, 220, 620, 360), R(0, 460, 620, 600))),
    "percent": Glyph(620, (R(0, 480, 200, 700), Cc(60, 540, 140, 620),
                           R(420, 0, 620, 220), Cc(480, 60, 560, 140),
                           Q((40, 0), (160, 0), (580, 700), (460, 700)))),
    "dollar": Glyph(620, (R(0, 0, 620, 700), Cc(200, 400, 620, 480),
                          Cc(0, 220, 420, 300), R(260, -60, 360, 760))),
    "ampersand": Glyph(620, (R(0, 380, 620, 700), Cc(260, 460, 620, 540),
                             R(0, 0, 540, 380), Cc(180, 90, 400, 240))),
    "at": Glyph(620, (Q((0, 0), (620, 0), (620, 300), (540, 300), (540, 400), (620, 400),
                        (620, 700), (0, 700)),
                      Cc(80, 80, 540, 620), R(180, 180, 440, 520), Cc(260, 300, 440, 380))),
    "asciicircum": Glyph(620, (Q((0, 440), (240, 440), (310, 520), (380, 440), (620, 440),
                                 (400, 700), (220, 700)),)),
    "underscore": Glyph(620, (R(0, -60, 620, 40),)),
    "grave": Glyph(400, (Q((240, 560), (400, 560), (260, 700), (100, 700)),)),
    "asciitilde": Glyph(620, (R(0, 380, 620, 620), Cc(0, 380, 420, 460),
                              Cc(200, 540, 620, 620))),
    "space": Glyph(240, ()),
}
